...
**Java Full Stack Developer | Spring Boot | React | Passionate about Scalable Web Solutions**

![Profile Views](https://komarev.com/ghpvc/?username=Priya-1911-R&color=blue&style=flat-square)
![GitHub Followers](https://img.shields.io/github/followers/Priya-1911-R?style=social)
...
- **Frontend:** Built responsive user interfaces with **Thymeleaf** templating and **Bootstrap** for seamless user experience.
- **Database:** Designed and optimized **PostgreSQL** schema for efficient handling of rooms, bookings, payments, and user data.
...
- **Core Features:** Timer-based quizzes, multiple question types (MCQ, true/false), instant scoring, and performance analytics.
- **Admin Module:** Developed a comprehensive dashboard for creating quizzes, managing questions, and viewing user results.
...
- **Database:** Leveraged **MongoDB** for flexible storage of property listings, user profiles, and image metadata.
- **Key Features:** Advanced property search with filters, favorites system, property comparison tool, and image upload/management.
- **User System:** Implemented role-based access control (Admin, Agent, Buyer) with appropriate permissions and dashboards.
- **Performance:** Optimized API responses and implemented efficient image handling for better user experience.
...
- **Advanced Spring Security** (OAuth2, Method Security)
